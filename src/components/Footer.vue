			...
			<div class="quarry-block">
				<div>
					...
					<div class="quarry-text">
						Quarry is a global, full-stack web product team that is
						empassioned about the work that it does. We’ll work
						together to design your digital product or web
						experience better than you imagined, and ship it faster
