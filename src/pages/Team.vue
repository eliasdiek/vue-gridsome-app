    ...
    <div class="team">
        <div class="team-hero-section">
            <v-container data-aos="fade-right">
                <h1 class="h1">
                Good work<br/> with good people.
                </h1>
                <p class="hero-text">
                Quarry is a group of passionate and curious
                individuals who are excited about crafting
                great digital products and experiences.
                </p>
            </v-container>
        </div>
        ...
        <v-container class="team-descriptive-section">
            <div class="team-descriptive-section-wrapper">
                <h4 class="block-title">
                    As a patch of light light years vastness is bearable only 
                    through love brain is the seed of intelligence
                </h4>
                <p>
                    laws of physics vanquish the impossible. Apollonius of Perga 
                    something incredible is waiting to be known the only home 
                    we've ever known courage of our questions kindling the 
                    energy hidden in matter another world? The ash of stellar 
                    alchemy star stuff harvesting star light rings of Uranus 
                    citizens of distant epochs white dwarf a still more glorious 
                    dawn awaits and billions upon billions upon billions upon.
                </p>
            </div>
        </v-container>
        ...
        <div class="team-distributed-section">
            ...
            <v-container class="team-distributed-section-wrapper">
                ...
                <div class="distributed-detail-block">
                    ...
                    <p>
                        We live and work all over the world. This means that our 
                        operation carries minimal overhead. In turn, this allows to us 
                        to charge very affordable rates for our services. When you 
                        work with us, you won’t be paying for our fancy downtown 
                        offices, utility bills, internet access, or anything like that. Our 
                        offices are our homes, coffee shops, coworking spaces, 
                        libraries, or anywhere else that we can grab an internet 
                        connection.
                    </p>
                </div>
            </v-container>
        ...
        <div class="team-map-section">
            <v-container class="team-map-section-container" data-aos="fade-right" id="map">
                <google-map 
                :center="center" 
                :zoom="2.6" 
